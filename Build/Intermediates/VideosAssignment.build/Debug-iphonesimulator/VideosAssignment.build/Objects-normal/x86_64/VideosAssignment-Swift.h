...
SWIFT_CLASS("_TtC16VideosAssignment11AppDelegate")
...
SWIFT_CLASS("_TtC16VideosAssignment14ViewController")
@interface ViewController : UIViewController
@property (nonatomic, weak) IBOutlet UITableView * __null_unspecified tableView;
@property (nonatomic, readonly, copy) NSArray<NSURL *> * __nonnull videos;
- (void)viewDidLoad;
...
@interface ViewController (SWIFT_EXTENSION(VideosAssignment)) <UITableViewDataSource>
